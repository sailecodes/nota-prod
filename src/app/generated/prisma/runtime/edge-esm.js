...
var Fe = (e, t) => () => (t || e((t = { exports: {} }).exports, t), t.exports),
  ...
  pa = (e, t, r, n) => {
    if ((t && typeof t == "object") || typeof t == "function")
      for (let i of la(t)) !ca.call(e, i) && i !== r && en(e, i, { get: () => t[i], enumerable: !(n = aa(t, i)) || n.enumerable });
    return e;
  };
var Qe = (e, t, r) => (
  (r = e != null ? sa(ua(e)) : {}), pa(t || !e || !e.__esModule ? en(r, "default", { value: e, enumerable: !0 }) : r, e)
);
var y,
  u = me(() => {
    "use strict";
          ...
          case 4:
            (l = e[i + 1]),
              ...
              (l & 192) === 128 &&
                (d & 192) === 128 &&
                (g & 192) === 128 &&
                ((h = ((o & 15) << 18) | ((l & 63) << 12) | ((d & 63) << 6) | (g & 63)), h > 65535 && h < 1114112 && (s = h));
        }
      }
...
function ja(e) {
  let t = { color: Ni[$a++ % Ni.length], enabled: xt.enabled(e), namespace: e, log: xt.log, extend: () => {} },
    r = (...n) => {
...
C.plus = C.add = function (e) {
  ...
  if (((d = h.d), (g = e.d), (a = v.precision), (l = v.rounding), !d[0] || !g[0])) return g[0] || (e = new v(h)), _ ? I(e, a, l) : e;
          ...
          (v = 0),
            ...
            d < 0
              ? ((ie = k[0]),
                ...
                D < F && R.unshift(0),
                r(k, R, F, l),
                d == -1 && ((F = k.length), (d = t($, k, ue, F)), d < 1 && (v++, r(k, ue < F ? rr : $, F, l))),
                (F = k.length))
              : d === 0 && (v++, (k = [0])),
            (B[h++] = v),
...
function bn(e, t, r, n) {
  var i,
    ...
    S = e.constructor,
    A = r !== void 0;
  if ((A ? (re(r, 1, Oe), n === void 0 ? (n = S.rounding) : re(n, 0, 8)) : ((r = S.precision), (n = S.rounding)), !e.isFinite())) g = fo(e);
  else {
    for (
      g = ge(e),
        s = g.indexOf("."),
        A ? ((i = 2), t == 16 ? (r = r * 4 - 3) : t == 8 && (r = r * 3 - 2)) : (i = t),
        s >= 0 && ((g = g.replace(".", "")), (v = new S(1)), (v.e = g.length - s), (v.d = fr(ge(v), 10, i)), (v.e = v.d.length)),
        h = fr(g, 10, i),
        o = l = h.length;
      h[--l] == 0;
    ...
    if (!h[0]) g = A ? "0p+0" : "0";
      ...
      if (
        (s < 0 ? o-- : ((e = new S(e)), (e.d = h), (e.e = o), (e = U(e, v, r, n, 0, i)), (h = e.d), (o = e.e), (d = oo)),
        (s = h[r]),
        (a = i / 2),
        (d = d || h[r + 1] !== void 0),
        (d =
...
function Dr({ args: e, errors: t, errorFormat: r, callsite: n, originalMethod: i, clientVersion: o, globalOmit: s }) {
  ...
  let { message: l, args: d } = Or(a, r),
    g = vr({ message: l, callsite: n, originalMethod: i, showColors: r === "pretty", callArguments: d });
...
var Mr = class {
    ...
    getAllComputedFields(t) {
      return this.computedFieldsCache.getOrCreate(t, () => Fo(this.previous?.getAllComputedFields(t), this.extension, t));
    }
...
function Ln(e, t) {
  let r = e._extensions.getAllModelExtensions(t) ?? {},
    n = [Tc(e, t), Ac(e, t), Ut(r), ee("name", () => t), ee("$name", () => t), ee("$parent", () => e._appliedParent)];
  return pe({}, n);
}
function Tc(e, t) {
  let r = we(t),
  ...
  ht = class {
    ...
    extractHostAndApiKey() {
      ...
      if (o !== "prisma:" && o !== pr)
        throw new Ue(`Error validating datasource \`${r}\`: the URL must start with the protocol \`prisma://\``, t);
      let l = a.get("api_key");
      if (l === null || l.length < 1) throw new Ue(`Error validating datasource \`${r}\`: the URL must contain a valid API key`, t);
      return [s, l];
    }
    metrics() {
    ...
    async handleError(t) {
      if (t instanceof je) throw (await this.uploadSchema(), new ft({ clientVersion: this.clientVersion, cause: t }));
      if (t) throw t;
    }
      ...
      (this.logEmitter = r),
        ...
        (this.dataloader = new Kr({
          batchLoader: ys(async ({ requests: n, customDataProxyFetch: i }) => {
            ...
            return (
              await this.client._engine.requestBatch(a, { traceparent: l, transaction: np(o), containsWrite: d, customDataProxyFetch: i })
            ).map((h, v) => {
