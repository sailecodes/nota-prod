...
var ne = (e, r) => () => (r || e((r = { exports: {} }).exports, r), r.exports),
  ...
  _o = (e, r, t, n) => {
    if ((r && typeof r == "object") || typeof r == "function")
      for (let i of Eu(r)) !xu.call(e, i) && i !== t && qt(e, i, { get: () => r[i], enumerable: !(n = bu(r, i)) || n.enumerable });
    return e;
  };
var k = (e, r, t) => (
    (t = e != null ? yu(wu(e)) : {}), _o(r || !e || !e.__esModule ? qt(t, "default", { value: e, enumerable: !0 }) : t, e)
  ),
...
var us = ne((Ng, ls) => {
  ...
  function gi(e, r) {
    ...
    if ("CI" in Q)
      return ["TRAVIS", "CIRCLECI", "APPVEYOR", "GITLAB_CI", "GITHUB_ACTIONS", "BUILDKITE"].some((n) => n in Q) || Q.CI_NAME === "codeship"
        ? 1
        : t;
...
${c}`);
  ...
  return r === "linux" && o && i
    ? `${o}-openssl-${i}`
    : (r !== "linux" && Gt(`Prisma detected unknown OS "${r}" and may not work as expected. Defaulting to "linux".`),
...
function Hc(e) {
  return JSON.parse(
    JSON.stringify(e, (r, t) => (Array.isArray(t) ? `[${t.map((n) => JSON.stringify(n)).join(", ")}]` : JSON.stringify(t))),
  );
}
var tt = {};
...
function Ui(e, r, t, n) {
  ...
  if ((g ? (ie(t, 1, Ke), n === void 0 ? (n = f.rounding) : ie(n, 0, 8)) : ((t = f.precision), (n = f.rounding)), !e.isFinite())) c = Js(e);
    ...
    if (!p[0]) c = g ? "0p+0" : "0";
      ...
      if (
        (s < 0 ? o-- : ((e = new f(e)), (e.d = p), (e.e = o), (e = F(e, d, t, n, 0, i)), (p = e.d), (o = e.e), (u = qs)),
        (s = p[t]),
        (a = i / 2),
        (u = u || p[t + 1] !== void 0),
        (u =
