...
var Fe = (e, t) => () => (t || e((t = { exports: {} }).exports, t), t.exports),
  ...
  oi = (e, t, r, n) => {
    if ((t && typeof t == "object") || typeof t == "function")
      for (let i of wa(t)) !ba.call(e, i) && i !== r && ar(e, i, { get: () => t[i], enumerable: !(n = ya(t, i)) || n.enumerable });
    return e;
  };
var Qe = (e, t, r) => (
    (r = e != null ? ha(Ea(e)) : {}), oi(t || !e || !e.__esModule ? ar(r, "default", { value: e, enumerable: !0 }) : r, e)
  ),
...
function Za(e) {
  let t = { color: Bi[Ya++ % Bi.length], enabled: Tt.enabled(e), namespace: e, log: Tt.log, extend: () => {} },
    r = (...n) => {
          ...
          (v = 0),
            ...
            d < 0
              ? ((ae = k[0]),
                ...
                D < F && R.unshift(0),
                r(k, R, F, l),
                d == -1 && ((F = k.length), (d = t($, k, ue, F)), d < 1 && (v++, r(k, ue < F ? or : $, F, l))),
                (F = k.length))
              : d === 0 && (v++, (k = [0])),
            (B[h++] = v),
...
function Rn(e, t, r, n) {
  var i,
    ...
    S = e.constructor,
    A = r !== void 0;
  if ((A ? (ie(r, 1, Oe), n === void 0 ? (n = S.rounding) : ie(n, 0, 8)) : ((r = S.precision), (n = S.rounding)), !e.isFinite())) g = yo(e);
  else {
    for (
      g = ge(e),
        s = g.indexOf("."),
    ...
    if (!h[0]) g = A ? "0p+0" : "0";
      ...
      if (
        (s < 0 ? o-- : ((e = new S(e)), (e.d = h), (e.e = o), (e = U(e, v, r, n, 0, i)), (h = e.d), (o = e.e), (d = lo)),
        (s = h[r]),
        (a = i / 2),
        (d = d || h[r + 1] !== void 0),
        (d =
...
function _r({ args: e, errors: t, errorFormat: r, callsite: n, originalMethod: i, clientVersion: o, globalOmit: s }) {
  ...
  let { message: l, args: d } = Mr(a, r),
    g = Tr({ message: l, callsite: n, originalMethod: i, showColors: r === "pretty", callArguments: d });
      ...
      (this.logEmitter = r),
        ...
        (this.dataloader = new en({
          batchLoader: Ts(async ({ requests: n, customDataProxyFetch: i }) => {
            ...
            return (
              await this.client._engine.requestBatch(a, { traceparent: l, transaction: ap(o), containsWrite: d, customDataProxyFetch: i })
            ).map((h, v) => {
